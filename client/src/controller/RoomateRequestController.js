...
export const getRoomateRequestByUserEmailAndApartmentId = async (
  userEmail,
  apartmentId
) => {
  let url =
    APP_ROUTES.roomateRequest.getRoomateRequestByUserEmailAndApartmentId;
  let data = { user_email: userEmail, appartment_id: apartmentId };
  return axios
    .get(url, {
      params: data,
      headers: GET_HEADERS(),
