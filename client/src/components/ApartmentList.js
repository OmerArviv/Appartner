...
const data=[{
    ...
    price: "1500$",
    roommates_images: ["check@gmail.com","https://images.squarespace-cdn.com/content/v1/522b327ee4b0673919bbe57a/1551246035214-6CO98SNBGLT6CXDAR2H1/%D7%92%D7%9C-%D7%A9%D7%9C%D7%95%D7%9D-%D7%9B%D7%94%D7%9F_01_1500.jpg",
     "https://images.squarespace-cdn.com/content/v1/522b327ee4b0673919bbe57a/1551246048479-DN3TH6PYE3PKCPDGMVNH/%D7%A0%D7%95%D7%A2%D7%94-%D7%9C%D7%A4%D7%99%D7%93%D7%95%D7%AA_01_1500.jpg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNJb4YAZHweJqUlstNOZkvbBlo3oeP_G6j5g&usqp=CAU"]
},
{
    image: "https://www.bhg.com/thmb/H9VV9JNnKl-H1faFXnPlQfNprYw=/1799x0/filters:no_upscale():strip_icc()/white-modern-house-curved-patio-archway-c0a4a3b3-aa51b24d14d0464ea15d36e05aa85ac9.jpg",
    address: "Rotchild , Tel Aviv",
...
function ApartmentList(){
    ...
    return(
        ...
        <List sx={{ display: "flex", flexDirection: "column",display: 'inline-flex', flexDirection: 'column', flexWrap: "wrap", alignItems: 'center' }}>
            ...
            {data.map((item, index)=>{ 
                return(
                    <Box component="div" sx={{display: "inline", marginRight:"auto"}}>
                        <ListItem>
